...
<body class="body">
<div id="header"><b>Aplikasi Pustaka C45<b></div>
<div id="navbar">
  <a href="index.php"><b>Home</b></a>
  <div id="dropdown">
    <div id="dropbtn"><b>Input</b></div>
  ...
  <div id="dropdown">
    <div id="dropbtn"><b>Cari</b></div>
    <div id="dropdown-content">
      <a href="carianggota.php" target="frameUtama"><b>Cari Anggota</b></a>
	  <a href="carikelompok.php" target="frameUtama"><b>Cari Kelompok Pustaka</b></a>
...
<div id="content">
<iframe src="Home.html" width="100%" height="770px" name="frameUtama" frameborder="0"></iframe>
</div>
<div id="footer">(C)2019 Agung Prabowo</div>
